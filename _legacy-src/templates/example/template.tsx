...
export function ExampleTemplate() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 text-zinc-50">
      ...
      <div className="pointer-events-none absolute inset-0 z-[5] bg-gradient-to-r from-zinc-950 via-zinc-950/70 to-transparent" />
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col justify-center px-6 pb-20">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
          Drop templates and components into this repo, preview them locally,
          then copy what you need into client projects.
        </p>

...
export interface LogoItemNode extends LogoItemBase {
  node: ReactNode;
}

export interface LogoItemImage extends LogoItemBase {
  src: string;
  srcSet?: string;
  sizes?: string;
  width?: number;
...
export interface LogoLoopProps {
  /** Array of logo items to display. Each item is a React node or an image src. */
  logos: LogoItem[];
  /** Animation speed in pixels per second. Negative values reverse direction. */
  speed?: number;
  ...
  gap?: number;
  /** Pause animation on hover. Superseded by `hoverSpeed` when provided. */
  pauseOnHover?: boolean;
  /** Speed when hovering. Set 0 to pause, or a lower value to decelerate. */
  hoverSpeed?: number;
  /** Apply fade-out effect at the edges of the container. */
  fadeOut?: boolean;

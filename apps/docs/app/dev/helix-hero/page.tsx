...
import { ShardsFocal } from "./shards-focal-lazy";
            ...
            <header className="hx-hero">
                <div className="hx-hero__copy">
                    ...
                    <p className="hx-body hx-hero__sub">
                        Helix threads a single deposit through every network it protects — one strand of capital
                        securing 38 services at once, fully liquid, never fragmented.
                    </p>
